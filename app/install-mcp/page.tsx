...
export default function InstallMCPPage() {
    ...
    const installCommands: Record<string, string> = {
        claude: `npx -y install-mcp@latest ${appUrl}/api/mcp --client claude`,
        vscode: `npx -y install-mcp@latest ${appUrl}/api/mcp --client vscode`,
        cursor: `npx -y install-mcp@latest ${appUrl}/api/mcp --client cursor`,
        cline: `npx -y install-mcp@latest ${appUrl}/api/mcp --client cline`,
    };
